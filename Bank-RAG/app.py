...
def get_conversation_chain(vectorstore):
    template = """
    You are a helpful and professional **Banking AI Assistant**.
    Your job is to assist users with banking-related queries such as:
    - Account details, transactions, and statements
    - Loans, credit cards, and deposits
    - Digital banking services
    - General financial guidance

    Use the following context from the documents to answer accurately.
    If you do not know the answer or it is outside banking scope, politely say you don’t know.

    Context: {context}
    User Question: {question}

    Answer as a professional bank representative:
    """
...
def main():
    ...
    if role == "🔑 Admin":
        ...
        # After login
        st.title("🛠 Admin Portal - Upload & Train Bot")
